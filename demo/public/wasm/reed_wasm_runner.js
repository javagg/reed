 ...
 * @returns {any}
 */
export function run_example(example, dim, nelem, p, q) {
    const ptr0 = passStringToWasm0(example, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_example(ptr0, len0, dim, nelem, p, q);
    if (ret[2]) {
